...
def _resolve_input_paths(repo_root: Path) -> tuple[list[Path], list[Path]]:
    ...
    """
    thermal_dir = repo_root / "data" / "thermal"
    rgb_dir = repo_root / "data" / "rgb"
...
def main() -> None:
    ...
    thermal_paths, rgb_paths = _resolve_input_paths(repo_root)
